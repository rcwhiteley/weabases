    ...
    $id_diagnostico = -1;
		...
		if ($rs) {
            ...
            if($obj){
                ...
                if($soyMedico)
                    echo '<button class="mx-5"> Cambiar </button>';  
                ?>
                </div>
                <div class="card-body">
                
                <form action="/agregar_sintoma.php" method="post">
                    <div class="row">
                        <div class="mx-3 form-group">
                            <input type="select" placeholder="Sintoma">
                        </div>
                        <div class="mx-3 form-group">
                         ...
                         <div class="mx-3 form-group">
                         <input type="submit" value="agregar" class="mx-3 input-sm btn btn-primary">
                         </div>
                    </div>
                ...
                if($soyMedico)
                echo '<button id="addReceta" class="btn btn-primary m-3"> Agregar receta</button>';
        
                echo '<button class="btn btn-primary m-3"> Ver licencias</button>';  
                if($soyMedico)
                echo '<button class="btn btn-primary m-3"> Agregar Licencia</button>';
